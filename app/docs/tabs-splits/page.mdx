---
title: Tabs & Splits
description: Master Frostty tabs and split panes with keyboard-first navigation, pane resizing, and practical terminal workflow patterns for active projects.
alternates:
  canonical: /docs/tabs-splits/
  languages:
    en: /docs/tabs-splits/
    x-default: /docs/tabs-splits/
---
